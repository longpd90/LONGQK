...
@property (strong, nonatomic) QKF58Label *firstLabel;
@property (strong, nonatomic) QKF58Label *secondLabel;
@property (strong, nonatomic) QKF58Label *lastLabel;
...
- (void)setupInterface {
    self.backgroundColor = kQKGlobalBackgroundGrayBlueColor;
    [self drawGrayLine];
...
- (void)setupStatusLabels {
    ...
    self.firstLabel = [[QKF58Label alloc] initWithFrame:CGRectMake(0, 7.0, witdhLabel, 24.0)];
    self.secondLabel = [[QKF58Label alloc] initWithFrame:CGRectMake(0, 7.0, witdhLabel, 24.0)];
    self.lastLabel = [[QKF58Label alloc] initWithFrame:CGRectMake(0, 7.0, witdhLabel, 24.0)];
    ...
    switch (caseSignup) {
        case 1:
            self.firstLabel.text = @"プロフィール";
            self.secondLabel.text = @"認証";
            self.lastLabel.text = @"履歴書";
            break;
        case 2:
