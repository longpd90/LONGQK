...
- (instancetype)initWithTarget:(id)target selector:(SEL)action {
    ...
    if (self) {
        ...
        self.imageView.image = [UIImage imageNamed:@"error_pic_offline.png"];
        ...
        self.retryButton = [[QKGlobalButton alloc] initWithFrame:CGRectMake(40.0, CGRectGetMaxY(self.messageLabel.frame) + 30.0, CGRectGetWidth(frame) - 80.0, 35.0)];
