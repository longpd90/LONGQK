...
@implementation QKCLShopInfoModel
...
- (instancetype)initWithResponse:(NSDictionary *)response {
    ...
    if (self) {
        ...
        self.paymentSystemTypeName = [response stringForKey:@"paymentSystemTypeName"];
        //paymentAddress not return
        ...
        self.relShopUserList = [[NSMutableArray alloc] init];
        for (NSDictionary *relShopUser in[response objectForKey:@"relShopUserList"]) {
            QKCLRelShopUserModel *model = [[QKCLRelShopUserModel alloc] initWithResponse:relShopUser];
            [self.relShopUserList addObject:model];
        }
        ...
        for (NSDictionary *freeItem in[response objectForKey:@"freeItemList"]) {
            QKCLShopFreeItemModel *model = [[QKCLShopFreeItemModel alloc] initWithResponse:freeItem];
